...
<Row className='mt-5'>   
<Col className='links mt-4' sm={2} style={{background: "#18183D", color:"white",overflow: 'hidden',height:'630px'}}>
  <h3>All</h3>
  <h6><a style={{color: "white",textDecoration:"none"}}href="/new">New Announcement</a></h6> 
  <Card.Link className='links' style={{color: "white",textDecoration:'none'}}href="/student">Courses</Card.Link>   
  <h6>Students</h6>
